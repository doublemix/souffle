...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/addStm.facts"},{"name","addStm"}});
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/divStm.facts"},{"name","divStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/minusStm.facts"},{"name","minusStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/multStm.facts"},{"name","multStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/setConstStm.facts"},{"name","setConstStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   setConstStm(l,r,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [83:1-83:41])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   addStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [84:1-84:39])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   minusStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [85:1-85:41])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   multStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [86:1-86:40])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   divStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [87:1-87:39])_");
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/flow.facts"},{"name","flow"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/const_prop/varEntry.facts"},{"name","varEntry"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_alpha(c)) :- 
   setConstStm(l,r,c).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [96:1-96:54])_");
if (!rel_5_setConstStm->empty()) [&](){
auto part = rel_5_setConstStm->partition();
PARALLEL_START;
CREATE_OP_CONTEXT(rel_5_setConstStm_op_ctxt,rel_5_setConstStm->createContext());
...
SignalHandler::instance()->setMsg(R"_(varEntry(l2,k,v) :- 
   varExit(l1,k,v),
   flow(l1,l2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [93:1-93:55])_");
...
SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_sum(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [100:1-102:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_minus(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [104:1-106:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_mult(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [108:1-110:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,v) :- 
   varEntry(l,r,v),
   !assignVar(l,r).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [117:1-117:57])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_div(v1,v2)) :- 
   ...
   varEntry(l,y,v2),
   v2 != &lat_alpha(0).
in file /home/doublemix/workspace/souffle-qxg2/mitch/const_prop.dl [112:1-114:67])_");
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","l\tk\tv"},{"filename","./out/const_prop/compiled-1/varEntry.csv"},{"name","varEntry"}});
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","l\tk\tv"},{"filename","./out/const_prop/compiled-1/varExit.csv"},{"name","varExit"}});
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
{
try{
souffle::CmdOptions opt(R"(const_prop.dl)",
R"(.)",
R"(.)",
false,
R"()",
