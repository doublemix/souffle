...
class Sf_sign : public SouffleProgram {
private:
...
std::unique_ptr<t_btree_3__0_1_2> rel_16_org_lat_varExit = std::make_unique<t_btree_3__0_1_2>();
...
std::unique_ptr<t_btree_3__0_1_2> rel_18_lat_temp_varExit = std::make_unique<t_btree_3__0_1_2>();
public:
Sf_sign() : 
...
wrapper_rel_8_varEntry(*rel_8_varEntry,symTable,"varEntry",std::array<const char *,3>{{"i:number","s:symbol","e:Sign{Top:s:symbol,Neg:s:symbol,Zer:s:symbol,Pos:s:symbol,Bot:s:symbol}"}},std::array<const char *,3>{{"l","k","v"}}),

wrapper_rel_13_varExit(*rel_13_varExit,symTable,"varExit",std::array<const char *,3>{{"i:number","s:symbol","e:Sign{Top:s:symbol,Neg:s:symbol,Zer:s:symbol,Pos:s:symbol,Bot:s:symbol}"}},std::array<const char *,3>{{"l","k","v"}}){
...
addRelation("varEntry",&wrapper_rel_8_varEntry,false,true);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/sign/addStm.facts"},{"name","addStm"}});
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/sign/divStm.facts"},{"name","divStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/sign/minusStm.facts"},{"name","minusStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/sign/multStm.facts"},{"name","multStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/sign/setConstStm.facts"},{"name","setConstStm"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   setConstStm(l,r,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [118:1-118:41])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   addStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [119:1-119:39])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   minusStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [120:1-120:41])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   multStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [121:1-121:40])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   divStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [122:1-122:39])_");
...
[&]() {
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"filename","./facts/sign/flow.facts"},{"name","flow"}});
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_alpha(c)) :- 
   setConstStm(l,r,c).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [96:1-96:54])_");
if (!rel_5_setConstStm->empty()) [&](){
auto part = rel_5_setConstStm->partition();
PARALLEL_START;
CREATE_OP_CONTEXT(rel_5_setConstStm_op_ctxt,rel_5_setConstStm->createContext());
...
rel_13_varExit->purge();
rel_13_varExit->insertAll(*rel_18_lat_temp_varExit);
...
SignalHandler::instance()->setMsg(R"_(varEntry(l2,k,v) :- 
   varExit(l1,k,v),
   flow(l1,l2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [93:1-93:55])_");
...
SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_sum(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [100:1-102:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_minus(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [104:1-106:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_mult(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [108:1-110:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,v) :- 
   varEntry(l,r,v),
   !assignVar(l,r).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [123:1-123:57])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_div(v1,v2)) :- 
   ...
   varEntry(l,y,v2),
   v2 != &lat_alpha(0).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign.dl [112:1-114:67])_");
...
rel_8_varEntry->purge();
rel_8_varEntry->insertAll(*rel_11_org_lat_varEntry);
...
rel_13_varExit->purge();
rel_13_varExit->insertAll(*rel_16_org_lat_varExit);
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","l\tk\tv"},{"filename","./out/sign/compiled/varEntry.csv"},{"name","varEntry"}});
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","l\tk\tv"},{"filename","./out/sign/compiled/varExit.csv"},{"name","varExit"}});
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
SouffleProgram *newInstance_sign(){return new Sf_sign;}
SymbolTable *getST_sign(SouffleProgram *p){return &reinterpret_cast<Sf_sign*>(p)->symTable;}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_sign: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_sign();
};
public:
factory_Sf_sign() : ProgramFactory("sign"){}
};
static factory_Sf_sign __factory_Sf_sign_instance;
}
#else
}
...
{
try{
souffle::CmdOptions opt(R"(sign.dl)",
R"(.)",
R"(.)",
false,
R"()",
