...
SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   setConstStm(l,r,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [118:1-118:41])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   addStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [119:1-119:39])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   minusStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [120:1-120:41])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   multStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [121:1-121:40])_");
...
();SignalHandler::instance()->setMsg(R"_(assignVar(l,r) :- 
   divStm(l,r,_,_).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [122:1-122:39])_");
...
SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_alpha(c)) :- 
   setConstStm(l,r,c).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [96:1-96:54])_");
if (!rel_5_setConstStm->empty()) [&](){
auto part = rel_5_setConstStm->partition();
PARALLEL_START;
CREATE_OP_CONTEXT(rel_5_setConstStm_op_ctxt,rel_5_setConstStm->createContext());
...
SignalHandler::instance()->setMsg(R"_(varEntry(l2,k,v) :- 
   varExit(l1,k,v),
   flow(l1,l2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [93:1-93:55])_");
...
SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_sum(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [100:1-102:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_minus(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [104:1-106:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_mult(v1,v2)) :- 
   ...
   varEntry(l,x,v1),
   varEntry(l,y,v2).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [108:1-110:48])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,v) :- 
   varEntry(l,r,v),
   !assignVar(l,r).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [123:1-123:57])_");
...
();SignalHandler::instance()->setMsg(R"_(varExit(l,r,&lat_div(v1,v2)) :- 
   ...
   varEntry(l,y,v2),
   v2 != &lat_alpha(0).
in file /home/doublemix/workspace/souffle-qxg2/mitch/sign/sign.dl [112:1-114:67])_");
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","l\tk\tv"},{"filename","sign/out/prog-200L-5002/compiled-8/varEntry.csv"},{"name","varEntry"}});
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","l\tk\tv"},{"filename","sign/out/prog-200L-5002/compiled-8/varExit.csv"},{"name","varExit"}});
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
...
{
try{
souffle::CmdOptions opt(R"(sign/sign.dl)",
R"(.)",
R"(.)",
false,
R"()",
