...
class Sf_mitch : public SouffleProgram {
private:
...
// -- Table: c
std::unique_ptr<t_btree_1__0> rel_3_c = std::make_unique<t_btree_1__0>();
souffle::RelationWrapper<1,t_btree_1__0,Tuple<RamDomain,1>,1> wrapper_rel_3_c;
// -- Table: @lat_temp_c
std::unique_ptr<t_btree_1__0> rel_4_lat_temp_c = std::make_unique<t_btree_1__0>();
// -- Table: a
std::unique_ptr<t_btree_2__0_1> rel_5_a = std::make_unique<t_btree_2__0_1>();
souffle::RelationWrapper<2,t_btree_2__0_1,Tuple<RamDomain,2>,2> wrapper_rel_5_a;
// -- Table: @lat_temp_a
std::unique_ptr<t_btree_2__0_1> rel_6_lat_temp_a = std::make_unique<t_btree_2__0_1>();
public:
Sf_mitch() : 
...
wrapper_rel_3_c(*rel_3_c,symTable,"c",std::array<const char *,1>{{"e:Lattice{Top:s:symbol,Neg:s:symbol,Pos:s:symbol,Bot:s:symbol}"}},std::array<const char *,1>{{"l"}}),
...
/* BEGIN STRATUM 0 */
[&]() {
SignalHandler::instance()->setMsg(R"_(b(1,"Bot").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test3.dl [23:1-23:13])_");
rel_1_b->insert(RamDomain(1),RamDomain(2147418114));
//TODO: visitLatNorm
std::swap(rel_1_b, rel_2_lat_temp_b);
if (!isHintsProfilingEnabled() && (performIO || 1)) rel_2_lat_temp_b->purge();
}();
/* END STRATUM 0 */
/* BEGIN STRATUM 1 */
[&]() {
SignalHandler::instance()->setMsg(R"_(c("Top").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test3.dl [24:1-24:10])_");
rel_3_c->insert(RamDomain(2147418111));
//TODO: visitLatNorm
std::swap(rel_3_c, rel_4_lat_temp_c);
...
SignalHandler::instance()->setMsg(R"_(a(n,l) :- 
   b(n,l),
   c(l).
in file /home/doublemix/workspace/souffle-qxg2/mitch/test3.dl [26:1-26:26])_");
...
Tuple<RamDomain,2> tuple({{static_cast<RamDomain>(env0[0]),static_cast<RamDomain>(lbf_glb(env0[1],env1[0]))}});
...
();//TODO: visitLatNorm
std::swap(rel_5_a, rel_6_lat_temp_a);
if (!isHintsProfilingEnabled() && (performIO || 1)) rel_6_lat_temp_a->purge();
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\tl"},{"filename","/home/doublemix/workspace/souffle-qxg2/mitch/out/a.csv"},{"name","a"}});
...
std::cout << "\n";
std::cout << "Relation rel_6_lat_temp_a:\n";
rel_6_lat_temp_a->printHintStatistics(std::cout,"  ");
std::cout << "\n";
}
...
SouffleProgram *newInstance_mitch(){return new Sf_mitch;}
SymbolTable *getST_mitch(SouffleProgram *p){return &reinterpret_cast<Sf_mitch*>(p)->symTable;}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_mitch: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_mitch();
};
public:
factory_Sf_mitch() : ProgramFactory("mitch"){}
};
static factory_Sf_mitch __factory_Sf_mitch_instance;
}
#else
}
...
{
try{
souffle::CmdOptions opt(R"(/home/doublemix/workspace/souffle-qxg2/mitch/test3.dl)",
R"(.)",
R"(.)",
false,
R"()",
