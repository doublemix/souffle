...
class Sf_test5 : public SouffleProgram {
private:
...
public:
Sf_test5() : 
wrapper_rel_1_a(*rel_1_a,symTable,"a",std::array<const char *,2>{{"i:number","e:Sign{Top:s:symbol,Neg:s:symbol,Zer:s:symbol,Pos:s:symbol,Bot:s:symbol}"}},std::array<const char *,2>{{"n","s"}}){
...
in file /home/doublemix/workspace/souffle-qxg2/mitch/test5.dl [30:1-30:13])_");
rel_1_a->insert(RamDomain(1),RamDomain(2147418111));
SignalHandler::instance()->setMsg(R"_(a(1,"Pos").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test5.dl [31:1-31:13])_");
rel_1_a->insert(RamDomain(1),RamDomain(2147418114));
SignalHandler::instance()->setMsg(R"_(a(2,"Pos").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test5.dl [33:1-33:13])_");
rel_1_a->insert(RamDomain(2),RamDomain(2147418114));
SignalHandler::instance()->setMsg(R"_(a(2,"Neg").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test5.dl [34:1-34:13])_");
rel_1_a->insert(RamDomain(2),RamDomain(2147418112));
SignalHandler::instance()->setMsg(R"_(a(3,"Pos").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test5.dl [36:1-36:13])_");
rel_1_a->insert(RamDomain(3),RamDomain(2147418114));
SignalHandler::instance()->setMsg(R"_(a(3,"Bot").
in file /home/doublemix/workspace/souffle-qxg2/mitch/test5.dl [37:1-37:13])_");
rel_1_a->insert(RamDomain(3),RamDomain(2147418115));
// LatNorm
if (!rel_1_a->empty()) {
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","n\ts"},{"filename","./out/a.csv"},{"name","a"}});
...
SouffleProgram *newInstance_test5(){return new Sf_test5;}
SymbolTable *getST_test5(SouffleProgram *p){return &reinterpret_cast<Sf_test5*>(p)->symTable;}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_test5: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_test5();
};
public:
factory_Sf_test5() : ProgramFactory("test5"){}
};
static factory_Sf_test5 __factory_Sf_test5_instance;
}
#else
}
...
{
try{
souffle::CmdOptions opt(R"(test5.dl)",
R"(.)",
R"(.)",
false,
R"()",
