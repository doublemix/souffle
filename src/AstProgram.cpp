...
void AstProgram::addAstLatticeBinaryFunction(std::unique_ptr<souffle::AstLatticeBinaryFunction> f) {
...
AstLatticeBinaryFunction* AstProgram::getAstLatticeBinaryFunction(const std::string& name) const {
